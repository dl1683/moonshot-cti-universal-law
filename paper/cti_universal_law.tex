...
Independent replication has begun: \citet{styves2025} (uncoordinated, published Sep.~2025) confirm centroid-separation geometry predicts per-category visual decoding across the entire human ventral stream --- the functional form of $\kappa_\mathrm{nearest}$ independently rediscovered in an orthogonal modality.
