...
kNN-based quality diagnostics are widely used \citep{wu2018,caron2021}. Neural collapse geometry \citep{papyan2020,han2022,zhu2021,rangamani2023,he2024} and spectral order parameters \citep{garrido2023,liu2025} predict downstream performance. None derive a universal slope connecting $\kappa_\mathrm{nearest}$ to $\logit(q)$ across architectures.
...
\item \textbf{Biological constants.} Law form confirmed; constants are $15$--$34\times$ smaller than NLP.
