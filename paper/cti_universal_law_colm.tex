...
All numerical claims are taken directly from repository artifacts including \texttt{results/cti\_audio\_speech.json}, \texttt{results/cti\_protein\_esm2.json}, \texttt{results/cti\_nsd\_human\_fmri.json}, and \texttt{results/cti\_cross\_modal\_rho.json}. Pre-registration timestamps are verifiable via git log. Code will be released upon acceptance.
